 ...
 */
import { createPayment, executeAgreement,executePayment, status } from './bkash.entity';
...
export default async function bkash() {
  ...
  this.route.get('/bkash/execute', executeAgreement({ ...this, bkash }));
  this.route.get('/bkash/execute/payment', executePayment({ ...this, bkash }));
